		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvisaprojectvisaproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvisaprojectvisaproject-display": {
								"semanticObject": "comvisaprojectvisaproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.visa.project.visaproject",
									"url": sap.ui.require.toUrl("com/visa/project/visaproject")
								}
							}
						}
					}
